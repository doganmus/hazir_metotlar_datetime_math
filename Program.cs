...
namespace hazir_metotlar_datetime_math
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(DateTime.Now.ToString("MMM")); //Nis
            Console.WriteLine(DateTime.Now.ToString("MMMM"));//Nisan
            ...
            Console.WriteLine(Math.Log(9)); //9 un e tabanındaki logortmik karşılığını getirir.
